...
App({
  globalData:{
    ...
    sdkappid: 1400166415,
    random: 2018211104,
    appkey: 'bc287a74a133ff05233f490ba5b03e33',
    sig:null,
    timestamp:null
  },
  onLaunch: function () {
...
function safe_add(x, y) {
  ...
  return (msw << 16) | (lsw & 0xFFFF);
    ...
    _this.globalData.timestamp = timestamp / 1000;
    console.log(_this.globalData.timestamp)

    _this.globalData.sig = hex_sha256('appkey=bc287a74a133ff05233f490ba5b03e33&random=2018211104&time=' + _this.globalData.timestamp+'&mobile=18510256511')
     
    console.log(_this.globalData.sig)
